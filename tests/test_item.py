...
def test_item_initialization_health_potion():
    ...
    potion = Item(name=item_name, description=item_description, properties=item_properties)
...
def test_item_initialization_iron_sword():
    ...
    sword = Item(name=item_name, description=item_description, properties=item_properties)
