...
class FloorDensityAdjuster:
    ...
    def __init__(self, connectivity_manager: MapConnectivityManager):
        ...
        Args:
            connectivity_manager: An instance of MapConnectivityManager for checking connectivity.
        """
    ...
    def _collect_inner_floor_tiles(
        ...
        This method was formerly _collect_floor_tiles in WorldGenerator, restricted to inner tiles.
        """
        floor_tiles = []
    ...
    def adjust_density(
        ...
        target_floor_tiles = max(target_floor_tiles, min(2, total_inner_tiles)) # Ensure at least 2 if possible

        current_inner_floor_tiles = self._collect_inner_floor_tiles(world_map, map_width, map_height)
                ...
                for r_x in range(1, map_width - 1):
                    ...
                    if tile and tile.type == "wall":
                        ...
                        for dr, dc in [(0, -1), (0, 1), (-1, 0), (1, 0)]:
                            ...
                            if 1 <= adj_x < map_width - 1 and 1 <= adj_y < map_height - 1:
        ...
        # Case 2: Too Many Floors
            ...
            # Re-collect floor tiles if we came from "too few" (though branches are exclusive)
            # This is mainly to ensure num_current_floor is accurate before this block.
            # current_inner_floor_tiles = self._collect_inner_floor_tiles(world_map, map_width, map_height)
            # num_current_floor = len(current_inner_floor_tiles) # Already up-to-date

            protected_tiles = {player_start_pos, original_win_pos}
            candidate_floors_to_wall = [
                (f_x, f_y) for f_x, f_y in current_inner_floor_tiles
